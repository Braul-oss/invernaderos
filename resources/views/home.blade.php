...
<body>
    ...
    <div class="mySlides fade">
        ...
        <p class="subtitle">Invernaderos diseñados para optimizar el aprovechamiento del espacio interior.</p>
	        <p class="link"><a href="{{ route('invernadero_validar') }}" class="btn btn-default btn-lg">Más información sobre invernaderos</a></p>
    </div>
    ...
    <div class="mySlides fade">
        ...
        <p class="link"><a href="{{ route('fertilizante_validar') }}" class="btn btn-default btn-lg">Descubre nuestros fertilizantes</a></p>
    </div>
    ...
    <div class="mySlides fade">
        ...
        <p class="link"><a href="{{ route('herramienta_validar') }}" class="btn btn-default btn-lg">Escoge entre nuestras herramientas</a></p>
    </div>
    ...
    <div class="mySlides fade">
        ...
        <p class="link"><a href="{{ route('planta_validar') }}" class="btn btn-default btn-lg">Conoce nuestras plantas</a></p>
    </div>
