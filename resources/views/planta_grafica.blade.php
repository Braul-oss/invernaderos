...
<head>
    ...
    <title>Gráficas de Plantas</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
</head>
<body>
    <h3>Gráficas de Plantas</h3>
    ...
    <br><br>
    <a href="{{ route('planta') }}" class="boton">Volver</a>
    ...
    <script>
        ...
        const graficaTipos = new Chart(ctxTipos, {
            ...
            data: {
                labels: labelsTipos,
                datasets: [{
                    label: 'Número de plantas por tipo',
                    data: dataTipos,
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
